    ...
    pub mod pricing_events {
        ...
        impl<'a> PricingEvent<'a> {
            ...
            pub fn best_bid(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_BEST_BID, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn best_ask(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_BEST_ASK, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn worse_ask(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_WORSE_ASK, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn worse_bid(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_WORSE_BID, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn execution_bid(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_EXECUTION_BID, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn execution_ask(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_EXECUTION_ASK, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn imbalance_bbo(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_IMBALANCE_BBO, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn imbalance_25(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_IMBALANCE_25, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn imbalance_50(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_IMBALANCE_50, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn imbalance_75(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_IMBALANCE_75, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn imbalance_100(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(PricingEvent::VT_IMBALANCE_100, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn depth(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(PricingEvent::VT_DEPTH, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> PricingEventBuilder<'a, 'b> {
            ...
            pub fn add_best_bid(&mut self, best_bid: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_BEST_BID, best_bid, 0.0);
            }
            #[inline]
            pub fn add_best_ask(&mut self, best_ask: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_BEST_ASK, best_ask, 0.0);
            }
            #[inline]
            pub fn add_worse_ask(&mut self, worse_ask: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_WORSE_ASK, worse_ask, 0.0);
            }
            #[inline]
            pub fn add_worse_bid(&mut self, worse_bid: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_WORSE_BID, worse_bid, 0.0);
            }
            #[inline]
            pub fn add_execution_bid(&mut self, execution_bid: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_EXECUTION_BID, execution_bid, 0.0);
            }
            #[inline]
            pub fn add_execution_ask(&mut self, execution_ask: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_EXECUTION_ASK, execution_ask, 0.0);
            }
            #[inline]
            pub fn add_imbalance_bbo(&mut self, imbalance_bbo: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_IMBALANCE_BBO, imbalance_bbo, 0.0);
            }
            #[inline]
            pub fn add_imbalance_25(&mut self, imbalance_25: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_IMBALANCE_25, imbalance_25, 0.0);
            }
            #[inline]
            pub fn add_imbalance_50(&mut self, imbalance_50: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_IMBALANCE_50, imbalance_50, 0.0);
            }
            #[inline]
            pub fn add_imbalance_75(&mut self, imbalance_75: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_IMBALANCE_75, imbalance_75, 0.0);
            }
            #[inline]
            pub fn add_imbalance_100(&mut self, imbalance_100: f32) {
                self.fbb_
                    .push_slot::<f32>(PricingEvent::VT_IMBALANCE_100, imbalance_100, 0.0);
            }
            #[inline]
        ...
        pub fn root_as_pricing_event(
            buf: &[u8],
        ) -> Result<PricingEvent, flatbuffers::InvalidFlatbuffer> {
        ...
        pub fn size_prefixed_root_as_pricing_event(
            buf: &[u8],
        ) -> Result<PricingEvent, flatbuffers::InvalidFlatbuffer> {
