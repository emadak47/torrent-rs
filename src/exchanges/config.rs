...
impl Config {
    pub fn binance() -> Self {
        Self {
            ...
            futures_ws_endpoint: "wss://stream.binance.com:9443/ws/futures".into(),
        }
    }
    ...
    pub fn okx() -> Self {
        Self {
            ...
            futures_ws_endpoint: "wss://ws.okx.com:8443/ws/v5/futures".into(),
        }
    }
    ...
    pub fn bybit() -> Self {
        Self {
            ...
            futures_ws_endpoint: "wss://stream.bybit.com/v5/public/linear".into(),
        }
    }
}