use async_wss::okx::{Channel as BullishChannel, Manager as BullishManager};
...
async fn main() {
    ...
    let products = vec!["BTCUSD".to_string() /* "ETH-USDT".to_string() */];
    ...
    wss.subscribe(BullishChannel::BOOKS.to_string(), products)
        .await
        .unwrap();
